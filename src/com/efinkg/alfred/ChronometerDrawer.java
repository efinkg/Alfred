...
public class ChronometerDrawer implements SurfaceHolder.Callback {
	...
	public ChronometerDrawer(Context context) {
		...
		mCountDownSoundId = mSoundPool.load(context, R.raw.countdown_bip,
				SOUND_PRIORITY);
	}
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		mChronometerView.layout(0, 0, mChronometerView.getMeasuredWidth(),
	...
	private void playSound(int soundId) {
		mSoundPool.play(soundId, 1 /* leftVolume */, 1 /* rightVolume */,
				SOUND_PRIORITY, 0 /* loop */, 1 /* rate */);
	}
}
